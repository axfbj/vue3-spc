      ...
      <div class="flex form-wrapper">
        ...
        <div class="right">
          <div class="flex justify-center my-width flex-sub align-center">
            ...
            <div class="title margin-left leading-normal">
              <span class="align-middle">MES系统</span>
            </div>
          </div>
          <div class="mt-8 form-container">
            <div class="item-wrapper">
              <n-input v-model:value="username" placeholder="请输入用户名/手机号" clearable>
                <template #prefix>
                  <n-icon>
                    <PhoneIcon />
                  </n-icon>
            ...
            <div class="mt-4 item-wrapper">
              <VerifySimple @verify-success="onVerfiySuccess" />
            </div>
            <div class="mt-4">
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const isVerfiySuccess = ref(false)
      ...
      function onVerfiySuccess() {
        isVerfiySuccess.value = true
      }
      const onLogin = () => {
        if (!isVerfiySuccess.value) {
