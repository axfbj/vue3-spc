...
export interface StateType {
  ...
  currentRoutes?: Array<RouteRecordRawWithHidden> // 只在 layoutMode === 'tlr' 模式下有用
...
export interface StoreType extends CacheView, VisitedView {
  ...
  changeSideBarCheckedEffect: (effect: string) => void
  changeAccordionMenu: (accordion: boolean) => void
