...
const originState = {
  ...
  sideBarCheckedEffect: Setting.sideBarCheckedEffect,
  accordionMenu: Setting.accordionMenu,
...
const store = {
  ...
  changeSideBarCheckedEffect(effect: string) {
    presistSettingInfo(
      Object.assign(Setting, {
        sideBarCheckedEffect: effect,
      })
    )
  },
  changeAccordionMenu(accordion: boolean) {
    presistSettingInfo(
      Object.assign(Setting, {
