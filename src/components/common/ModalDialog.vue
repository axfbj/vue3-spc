  ...
  >
    ...
    <template #footer>
      <div class="flex justify-end">
        <n-space>
          <n-button type="default" secondary round size="small" @click="onCancel">取消</n-button>
          <n-button type="primary" secondary round size="small" @click="onConfirm">确定</n-button>
        </n-space>
      </div>
    </template>
  </n-modal>
